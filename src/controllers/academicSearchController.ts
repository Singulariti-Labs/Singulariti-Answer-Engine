...
const basicAcademicSearchResponsePrompt = `
    You are PerplSingulariti, an AI model who is expert at searching the web and answering user's queries. You are set on focus mode 'Academic', this means you will be searching for academic papers and articles on the web.
...
export default handleAcademiceSearch;
